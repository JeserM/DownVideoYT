...
-   cambiado la libreria de pytube, ya no funciona, por pytubefix.
-   posibilidad de seleccionar la ruta de descarga con una ventana de selección.

Ahora mismo entre las pruebas que se puede realizar, la descarga de video en el caso de resoluciones de 360P se descarga audio y video en un solo fichero. Para mayores resoluciones hay que bajar audio por un lado y video por otro, para luego juntarlos. Se puede hacer por ejemplo con VLC.
