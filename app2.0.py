...
# ! no use "on_progress_callback=on_progress" muestra una barra pero en la consola. con este adornador muestra la barra en la web
    ...
    def getPermissionToCOntinue(self, file_size):
        ...
        if st.button("Seleccionar carpeta de descarga"):
            self.download_path = self.select_download_path()
            st.text_input("Ruta de descarga seleccionada",
    ...
    #     st.button("Seleccionar carpeta de descarga")
    #     root = tk.Tk()
    #     root.withdraw()
    ...
    def download(self):
        if self.download_path:
            ...
            st.error("Por favor, seleccione una carpeta de descarga primero.")
    # @staticmethod
